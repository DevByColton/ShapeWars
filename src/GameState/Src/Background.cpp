...
{
    topLeftNotch[0].position = {20.f, 20.f};
    topLeftNotch[1].position = {20.f, 75.f};
    topLeftNotch[2].position = {75.f, 20.f};
    topLeftNotch[0].color = NOTCH_COLOR;
    topLeftNotch[1].color = NOTCH_COLOR;
    topLeftNotch[2].color = NOTCH_COLOR;

    topRightNotch[0].position = {GameRoot::instance().windowSizeF.x - 20.f, 20.f};
    topRightNotch[1].position = {GameRoot::instance().windowSizeF.x - 20.f, 75.f};
    topRightNotch[2].position = {GameRoot::instance().windowSizeF.x - 75.f, 20.f};
    topRightNotch[0].color = NOTCH_COLOR;
    topRightNotch[1].color = NOTCH_COLOR;
    topRightNotch[2].color = NOTCH_COLOR;

    bottomRightNotch[0].position = {GameRoot::instance().windowSizeF.x - 20.f, GameRoot::instance().windowSizeF.y - 20.f};
    bottomRightNotch[1].position = {GameRoot::instance().windowSizeF.x - 20.f, GameRoot::instance().windowSizeF.y - 75.f};
    bottomRightNotch[2].position = {GameRoot::instance().windowSizeF.x - 75.f, GameRoot::instance().windowSizeF.y - 20.f};
    bottomRightNotch[0].color = NOTCH_COLOR;
    bottomRightNotch[1].color = NOTCH_COLOR;
    bottomRightNotch[2].color = NOTCH_COLOR;

    bottomLeftNotch[0].position = {20.f, GameRoot::instance().windowSizeF.y - 20.f};
    bottomLeftNotch[1].position = {20.f, GameRoot::instance().windowSizeF.y - 75.f};
    bottomLeftNotch[2].position = {75.f, GameRoot::instance().windowSizeF.y - 20.f};
